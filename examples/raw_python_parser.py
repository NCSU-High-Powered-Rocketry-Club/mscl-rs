...
EST_MAP = {
    ...
    0x03: ('>ffffH', ['estOrientQuaternionW', 'estOrientQuaternionX', 'estOrientQuaternionY', 'estOrientQuaternionZ'], 'estOrientQuaternion'),
    0x12: ('>ffffH', ['estAttitudeUncertQuaternionW', 'estAttitudeUncertQuaternionX', 'estAttitudeUncertQuaternionY', 'estAttitudeUncertQuaternionZ'], 'estAttitudeUncertQuaternion'),
    0x0E: ('>fffH',  ['estAngularRateX', 'estAngularRateY', 'estAngularRateZ'], 'estAngularRate'),
    0x1C: ('>fffH',  ['estCompensatedAccelX', 'estCompensatedAccelY', 'estCompensatedAccelZ'], 'estCompensatedAccel'),
    0x0D: ('>fffH',  ['estLinearAccelX', 'estLinearAccelY', 'estLinearAccelZ'], 'estLinearAccel'),
    0x13: ('>fffH',  ['estGravityVectorX', 'estGravityVectorY', 'estGravityVectorZ'], 'estGravityVector'),
}
